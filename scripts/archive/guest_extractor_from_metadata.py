#!/usr/bin/env python3
"""
Guest Extractor from RSS Metadata
Extracts all guests from podcast_metadata folder with improved patterns
"""
...
def extract_guest_from_title(title, podcast_name):
    ...
    # The Loud And Quiet: "Guest Name topic" (guest name at start)
